...
//	}
	...
	/**
	 * Takes the list of entities, then decrypts their contents and stores them to a plain-text file
	 * that can be read in by this application.<br><b>
	 * MIGHT I REMIND YOU THAT THIS IS A TERRIBLE THING TO DO???</b><br>
	 * @param listOfEntities
	 */
	public void storeDomainEntitiesToFile(ArrayList<DomainEntity> listOfEntities)
	{
		
	}
	
	/**
	 * Parses a file and generates a list of TempDomainEntities from its contents.
	 ...
	 * @return ArrayList of TempDomainEntities from the file contents. Call DomainEntity.createNewDomainEntityFromComponents()
	 * to create encrypted database objects from the TempDomainEntities
	 * @throws FileNotFoundException 
	 * @throws DataFileFormatException 
	 */
